...
_DGRAM_SWITCH_GOES_ON = b"#bundle\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x10/SYNC\x00\x00\x00,f\x00\x00?\x00\x00\x00"
...
_DGRAM_INVALID_INDEX = b"#bundle\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x20/SYNC\x00\x00\x00\x00"

_DGRAM_UNKNOWN_TYPE = b"#bundle\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x10iamnotaslash"
...
class TestOscBundle(unittest.TestCase):
    ...
    def test_raises_on_invalid_datagram(self):
        ...
        self.assertRaises(osc_bundle.ParseError, osc_bundle.OscBundle, _DGRAM_INVALID_INDEX)
