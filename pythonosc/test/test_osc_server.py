...
class TestUDPHandler(unittest.TestCase):
    ...
    def test_no_match(self):
        ...
        osc_server._UDPHandler([_SIMPLE_PARAM_INT_MSG, None], self.client_address, self.server)
    ...
    def test_match_int9(self):
        ...
        osc_server._UDPHandler([_SIMPLE_PARAM_INT_9, None], self.client_address, self.server)
    ...
    def test_match_without_args(self):
        ...
        osc_server._UDPHandler([_SIMPLE_MSG_NO_PARAMS, None], self.client_address, self.server)
    ...
    def test_response_no_args(self):
        ...
        osc_server._UDPHandler((_SIMPLE_PARAM_INT_MSG, mock_sock), self.client_address, self.server)
        mock_sock.sendto.assert_called_with(b"/SYNC\00\00\00,\00\00\00", ("127.0.0.1", 8080))
